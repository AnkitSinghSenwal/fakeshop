  ...
  return (
    <>
      <div className=' m-1  text-center text-2xl text-emerald-50 flex justify-center items-center gap-1 sm:flex-col' >
        ...
        <div className="bg-slate-400 rounded p-2 w-full"
        >CART</div>
      ...
      {cart && cart.length ? (
        ...
        <div className="h-60 w-screen flex flex-col gap-4 justify-center items-center text-center text-cyan-400 text-4xl font-bold">
          Your cart is empty...
          <Link to={'/fakeshop/'}> <div className="inline-block px-5 py-2 bg-gray-700 text-gray-100 no-underline rounded-md text-sm text-center transition-transform duration-200 ease-in-out  hover:bg-blue-300 hover:scale-105 active:scale-95 w-35">SHOP NOW</div></Link>
        </div>
